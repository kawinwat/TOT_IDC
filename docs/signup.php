				...
				<div class="col-sm-10 col-md-8 col-lg-6 mx-auto d-table h-100">
					<div class="d-table-cell align-middle">
						<div class="text-center mt-4">
							...
							<p class="lead">
								เพิ่มข้อมูลผู้ที่สามารถใช้งานได้
							</p>
						</div>
						<div class="card">
							<div class="card-body">
								<div class="m-sm-4">
									<form action="check_signup.php" method="POST" id="signup">
										...
										<div class="form-group">
											...
											<input class="form-control form-control-lg" type="password" id="confirm_password" name="confirm_password" placeholder="Re-enter password" required />
										</div>
										<div class="form-group">
											<label>Level</label>
											<select id="cars" name="level" required>
